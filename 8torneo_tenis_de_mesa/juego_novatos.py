from registrarJugador import  jugadores_novatos,limpiar_consola
jugar_sets = 2

def validar_datos_novatos():
    limpiar_consola()
    global nomJ1, nomJ2
    ...
    for jugadorBuscar in jugadores_novatos:
    ...
    for jugadorBuscar1 in jugadores_novatos:
    ...
    for i in range(jugar_sets):
        ...
        try: 
            ...
            if (set1jugador1 > set1jugador2):
                ...
                for jugador in jugadores_novatos:  
                ...
                for jugadorPerdedor in jugadores_novatos:
                ...
                for jugador1 in jugadores_novatos:
                ...
                for jugadorPerdedor1 in jugadores_novatos:
