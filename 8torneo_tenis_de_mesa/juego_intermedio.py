from registrarJugador import jugadores_intermedios, limpiar_consola
jugar_sets = 2
def validar_datos_intermedio():
    limpiar_consola()
    global nomJ1, nomJ2
    ...
    for jugadorBuscar in jugadores_intermedios:
    ...
    for jugadorBuscar1 in jugadores_intermedios:
...
def juego_intermedio():
    ...
    for i in range(jugar_sets):
        ...
        if (set1jugador1 > set1jugador2):
            ...
            for jugador in jugadores_intermedios:  
            ...
            for jugadorPerdedor in jugadores_intermedios:
            ...
            for jugador1 in jugadores_intermedios:
            ...
            for jugadorPerdedor1 in jugadores_intermedios:
